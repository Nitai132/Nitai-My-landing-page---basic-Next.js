...
const data = {
  subTitle: 'using advaced technologies you will get the best results for your website.',
  title: 'Get the maximum out of your website.',
  features: [
    {
      id: 1,
      imgSrc: Secure,
      ...
      text:
        'I will make sure to keep your Web-app functionality as smart and fast as possible.',
    },
    {
      id: 2,
      imgSrc: Briefcase,
      ...
      text:
        'I will make sure you contect is Secure over the web',
    },
  ],
};
